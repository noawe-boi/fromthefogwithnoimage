...
function lunareclipse.watching:sightings/skin_library/build_model/define_part with storage lunareclipse.watching:global_values skin_library.temp.assemble
