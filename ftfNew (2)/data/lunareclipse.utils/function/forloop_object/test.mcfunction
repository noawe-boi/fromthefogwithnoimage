...
# + Extra defined object values, case specific.

$say The following info is from $(target) $(path)[$(index)] and is currently being run from the command $(command) here is the value that changes $(value).