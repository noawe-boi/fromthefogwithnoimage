...
$execute if data storage lunareclipse.watching:global_values {skin_library:{temp:{assemble:{part:"right_arm_item"}}}} run return run data modify storage lunareclipse.watching:global_values skin_library.skin.$(skin).assembled append value {id:"minecraft:item_display",view_range:1f,item_display:"thirdperson_righthand",Tags:["watching.config","watching.preview_skin"],transformation:$(pivot)}

# Add this part to the previous one.
$data modify storage lunareclipse.watching:global_values skin_library.skin.$(skin).assembled append value {id:"minecraft:item_display",view_range:1f,brightness:{sky:15,block:15},Tags:["watching.config","watching.preview_skin"],item:{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"$(namespace):skins/$(skin)/$(part)"}},transformation:$(pivot)}
$data modify storage lunareclipse.watching:global_values skin_library.skin.$(skin).assembled append value {id:"minecraft:item_display",view_range:1f,brightness:{sky:15,block:15},Tags:["watching.config","watching.preview_skin"],item:{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"$(namespace):skins/$(skin)/emissive/$(part)"}},transformation:$(pivot)}