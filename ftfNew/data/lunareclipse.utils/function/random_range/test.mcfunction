...
$say The following info is from grabbing a random number between $(starting_number) and $(ending_number): $(value). This number was displayed by running this function: $(command).