...
# "identifier" - The command that is meant to run with the information. (Added just for this.)

# Increment the array length.
$scoreboard players add $(identifier)_array_length lunareclipse_utils.global_values 1